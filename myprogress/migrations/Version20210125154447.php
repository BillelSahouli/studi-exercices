 ...
 */
final class Version20210125154447 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE performance ADD user_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_82D79681A76ED395 ON performance');
        $this->addSql('ALTER TABLE performance DROP user_id');
    }
}

...
return [
    ...
    [ // $regexpList
        0 => '{^(?'
                ...
                .'|/mo(?'
                    .'|n\\-exercice/([^/]++)(*:195)'
                    .'|difier\\-mon\\-mot\\-de\\-passe/([^/]++)(*:239)'
                .')'
                .'|/compte/(?'
                    .'|modifier\\-performance/([^/]++)(*:289)'
                    .'|suprimer\\-performance/([^/]++)(*:327)'
                .')'
            .')/?$}sDu',
    ],
    [ // $dynamicRoutes
        ...
        195 => [[['_route' => 'exercice', '_controller' => 'App\\Controller\\ExerciceController::show'], ['id'], null, null, false, true, null]],
        239 => [[['_route' => 'update_password', '_controller' => 'App\\Controller\\ResetPasswordController::update'], ['token'], null, null, false, true, null]],
        289 => [[['_route' => 'edit_performance', '_controller' => 'App\\Controller\\MyPerformanceController::edit'], ['id'], null, null, false, true, null]],
        327 => [

...
class __TwigTemplate_fbca516ae30e6adfcf796eb0523ae4bcd61f6e7d27c8b33f4c157ba9bf2bc775 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        <div class=\"card-profil\">
            ...
            echo " ici tu peut modifier ton mot de passe
                    </div>
            ...
            echo "\" class=\"btn btn-primary\">Clique ici</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    {
        return array (  107 => 18,  100 => 14,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Mon Compte - MY PROGRESS{% endblock %}
    ...
    {% if app.user %}
        ...
        <div class=\"card-profil\">
            <div class=\"col-md-2\">
                <div class=\"card bg-light\">
                    <div class=\"card-header text-center\">
                        {{ app.user.firstname }} ici tu peut modifier ton mot de passe
                    </div>
                    <div class=\"card-body text-center\">
                        <p class=\"card-text\">Modifier mes informations ?</p>
                        <a href=\"{{ path('account_password') }}\" class=\"btn btn-primary\">Clique ici</a>
                    </div>
                </div>
            </div>
        </div>
    {% endif %}
{% endblock %}", "account/index.html.twig", "C:\\wamp64\\www\\studi-exercices\\myprogress\\templates\\account\\index.html.twig");
    }
}
